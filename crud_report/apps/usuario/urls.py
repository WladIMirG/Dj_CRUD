...
from apps.usuario.views import SalePDF, InicioUsuarios,ListadoUsuario, RegistrarUsuario,EditarUsuario,EliminarUsuario
...
urlpatterns = [
    ...
    path('salepdf/<int:pk>/', SalePDF.as_view(), name= 'generar_reporte'),
]
